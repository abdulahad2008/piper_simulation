...
\planned{AUC, ICC and top permutation importances per cell. The per-episode
randomisation vector needed for this is already logged in every archived CSV,
so the analysis is available for the Phase~0 cells today and for each new cell
as it lands.}
\todo{Run and fill.}
